...
public class Artikal implements Serializable{
   ...
   /** @pdRoleInfo migr=no name=StavkaCenovnika assc=association6 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   private java.util.Collection<StavkaCenovnika> cene;
   /** @pdRoleInfo migr=no name=StavkaAkcije assc=association15 coll=java.util.Collection impl=java.util.HashSet mult=0..* */
   private java.util.Collection<StavkaAkcije> akcije;
   /** @pdRoleInfo migr=no name=Skladistenje assc=association17 coll=java.util.Collection impl=java.util.HashSet mult=0..* */
   ...
   public Artikal(int sifra, String naziv, String opis) {
	   this();
	   this.sifra = sifra;
	   this.naziv = naziv;
	   this.opis = opis;
