...
public class StavkaCenovnika implements Serializable {
	...
	public void setCenovnik(Cenovnik newCenovnik) {
		/*
		 * if (this.cenovnik == null || !this.cenovnik.equals(newCenovnik)) { if
		 * (this.cenovnik != null) { Cenovnik oldCenovnik = this.cenovnik; this.cenovnik
		 * = null; oldCenovnik.removeStavke(this); } if (newCenovnik != null) {
		 * this.cenovnik = newCenovnik; this.cenovnik.addStavke(this); } }
		 */
