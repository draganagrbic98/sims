...
public class WebShop implements Serializable{
   ...
   /** @pdRoleInfo migr=no name=Povratak assc=association24 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   ...
   /** @pdRoleInfo migr=no name=Artikal assc=association3 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   private java.util.Collection<Artikal> artikli;
   /** @pdRoleInfo migr=no name=Cenovnik assc=association4 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   private java.util.Collection<Cenovnik> cenovnici;
   /** @pdRoleInfo migr=no name=Objekat assc=association12 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   private java.util.Collection<Objekat> objekti;
   /** @pdRoleInfo migr=no name=Akcija assc=association13 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
   private java.util.Collection<Akcija> akcije;
   /** @pdRoleInfo migr=no name=Narudzbenica assc=association19 coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Aggregation */
...
/** @pdGenerated default getter */
   ...
   public void dodajArtikal(int sifra, String naziv, String opis) {
      // TODO: implement
   ...
   public void obrisiArtikal(int sifra) {
      // TODO: implement
